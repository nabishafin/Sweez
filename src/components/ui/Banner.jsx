...
const Banner = () => {
    return (
        <div className="relative h-[700px] flex items-center justify-center bg-gradient-to-r from-[#121324] to-[#03041a] overflow-hidden">
            ...
            <div className="text-center z-10">
                ...
                <motion.button
                    className="bg-white text-blue-800 px-8 py-3 rounded-full font-semibold hover:bg-blue-100 transition-all"
            ...
            />
            <motion.div
                className="absolute bottom-20 right-20 w-12 h-12 bg-white rounded-full opacity-10"
                initial={{ y: 0 }}
                animate={{ y: [0, -20, 0] }}
