        ...
        <div className="bg-white dark:bg-gray-900 py-12">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
                    {stats.map((stat) => {
                        // Using `useInView` to detect when the stat comes into view
                        ...
                        return (
                            ...
                            >
                                <div className="mb-4">
                                    {/* Icons based on stat.icon */}
                                    {stat.icon === 'handshake' && (
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-blue-500 dark:text-blue-400 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <h3 className="text-2xl font-bold text-blue-500 dark:text-blue-400">
                                    {/* Only show CountUp if the element is in view */}
                                    {inView && (
                                        <CountUp
                                            start={0}
                                            end={stat.value}
